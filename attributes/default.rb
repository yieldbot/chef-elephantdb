default['elephantdb']['version'] = '0.2.0-wip3'
...
default['elephantdb']['src_repo'] = 'git://github.com/yieldbot/elephantdb.git'
default['elephantdb']['src_branch'] = 'yieldbot'
default['elephantdb']['port'] = 3578
default['elephantdb']['download_rate_limit'] = 1024
default['elephantdb']['update_interval'] = 60
default['elephantdb']['domain_prefix'] = ''
default['elephantdb']['java_opts'] = '-server'
